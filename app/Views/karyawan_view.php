                        ...
                        <tbody>
                            ...
                            foreach ($getKaryawan as $krywn) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('karyawan/edit/' . $krywn['id']); ?>" class="btn btn-success" data-target="#editModal">
                                            Edit</a>
                                        <a href="<?= base_url('karyawan/hapus/' . $krywn['id']); ?>" onclick="javascript:return confirm('Apakah Anda yakin ingin menghapus data karyawan?')" class="btn btn-danger">
                                            Hapus</a>
                                    </td>
                                </tr>
                            <?php $no++;
